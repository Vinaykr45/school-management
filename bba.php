...
<!--body-->
  <section>
    ...
    <div class="container" id="syllabus">
      ...
      <div class="col-md-8">
      <h2 class="bg-primary text-center text-white sy-head " style="padding: 5px;">BBA (Bachelor of Business Administration)</h2>
      <div class="mu-latest" style="background-color:#f8f8f8;">
         <h2 class="mu-head"><strong>BBA Program Information</strong></h2>
         <table class="table">
           <tbody>
             <tr>
               <th style="color:#000; font-size:13px;">BBA Eligibility:</th>
               <td style="color:#000; font-size:13px;">10+2 from any recognized Board</td>
             </tr>
             <tr>
              <th style="color:#000; font-size:13px;">BBA Duration:</th>
              <td style="color:#000; font-size:13px;">3 Years</td>
            </tr>
            <tr>
              <th style="color:#000; font-size:13px;">BBA Intake:</th>
              <td style="color:#000; font-size:13px;">100</td>
            </tr>
           </tbody>
         </table>
         <h2 class="mu-head" style="margin-top: 50px;"><strong>BBA Program Objective</strong></h2>
         <p style="text-align: justify;">Our BBA programme at Gosser College, Ranchi provides graduates with the skills and knowledge to take on appropriate professional positions upon graduation.
        ...
        <div class="accordion" id="accordionExample">
          <h2 style="font-size: 25px; margin-top: 20px;margin-bottom: 15px;">BBA Syllabus</h2>
        ...
        <div class="col-md-4">
          ...
          <p><a href="bca.html">Department of BCA</a></p>
          <hr>
          <p><a href="bba.html">Department of BBA</a></p>
          </div>
          <br>
